...
STARTER_TEMPLATES = [
    {
        ...
        "nodes": [
            ...
            {"type": "pipeline_longlive", "position": {"x": 300, "y": 200}},
            {"type": "pipelineOutput", "position": {"x": 500, "y": 200}},
        ],
        "edges": [
            {"source": 0, "target": 1},
            {"source": 1, "target": 2},
    ...
    },
    {
        "id": "wan21",
        "name": "Wan2.1 Video",
        "description": "Wan2.1 video generation pipeline - high quality video output",
        "category": "Starter",
        "icon": "🎬",
        "nodes": [
            {
                ...
                "config": {
                    "pipelineId": "wan21",
                    "pipelineName": "Wan2.1 Video",
                    "pipelineDescription": "Wan2.1 video generation pipeline",
                    "usage": "main",
                    "mode": "video",
                    "supportsPrompts": True,
                    "remoteInference": False,
            ...
            {"type": "pipeline_wan21", "position": {"x": 300, "y": 200}},
            {"type": "pipelineOutput", "position": {"x": 500, "y": 200}},
        ],
        "edges": [
            {"source": 0, "target": 1},
    ...
    # Community Plugin Templates (from actual plugins)
    {
        ...
        "nodes": [
            ...
            {"type": "videoInput", "position": {"x": 100, "y": 200}},
            {"type": "pipeline_passthrough", "position": {"x": 300, "y": 200}},
            {
                "type": "kaleido",
                "position": {"x": 500, "y": 200},
                "config": {"slices": 6, "rotation": 0, "zoom": 1},
            },
            {"type": "postprocessorOutput", "position": {"x": 700, "y": 200}},
        ],
        "edges": [
            {"source": 0, "target": 1},
            {"source": 1, "target": 2},
    ...
    },
    {
        ...
        "nodes": [
            ...
            {"type": "pipeline_passthrough", "position": {"x": 500, "y": 200}},
            {"type": "preprocessorOutput", "position": {"x": 700, "y": 200}},
        ],
        "edges": [
            {"source": 0, "target": 1},
            {"source": 1, "target": 2},
